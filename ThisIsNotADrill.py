...
class Button:
    ...
    def wrong(self):
        gameDisplay = pygame.display.set_mode((800, 600))
        caption4 = Text("BOO-lean!", self.white, size=(300, 100, 10, 10))
...
class Game:
    ...
    def window(self):
        ...
        # from the room.
        pygame.display.set_caption('Escape the Softdes Project')
        riddle = Text("What Is A Boolean?", self.white)
        # Ans = short
        riddle.message_display(self.gameDisplay)

        button1 = Button(size=(100, 200, 200, 350), color=(self.mystery),
                         color_bright=(self.red))
        caption1 = Text("False", self.white, size=(100, 200, 200, 350))
        button2 = Button(size=(500, 200, 200, 350), color=(self.mystery2),
                         color_bright=(self.blue))
        caption2 = Text("True", self.white, size=(500, 200, 200, 350))
